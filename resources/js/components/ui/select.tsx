...
function SelectTrigger({
    ...
    return (
        <SelectPrimitive.Trigger
            ...
            className={cn(
                // KELAS-KELAS INI YANG KITA UBAH:
                "text-gray-900 dark:text-gray-200", // 1. Menambahkan warna teks default yang gelap
                "data-[placeholder]:text-gray-400 dark:data-[placeholder]:text-gray-500", // 2. Membuat warna placeholder lebih terlihat
                
                // Kelas-kelas lain tetap sama
                "border-input focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive flex h-9 w-full items-center justify-between rounded-md border bg-transparent px-3 py-2 text-sm shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 [&_svg:not([class*='text-'])]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&>span]:line-clamp-1",
                className
            )}
            {...props}
        >
...
// =======================================================
// TIDAK ADA PERUBAHAN DI KOMPONEN LAIN DI BAWAH INI
// =======================================================
